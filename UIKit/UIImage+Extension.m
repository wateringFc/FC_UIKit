...
+ (UIImage *)fc_imageWithColor:(UIColor *)color {
    return [self fc_imageWithColor:color size:CGSizeMake(1, 1)];
}

#pragma mark - 用颜色返回一张图片
+ (UIImage *)fc_imageWithColor:(UIColor *)color size:(CGSize)size {
...
- (UIImage *)fc_addFilter:(NSString *)filterName {
...
- (UIImage *)fc_alpha:(CGFloat)alpha {
...
#pragma mark - 设置圆角图片
- (UIImage *)fc_imageByRoundCornerRadius:(CGFloat)radius {
    return [self fc_imageByRoundCornerRadius:radius borderWidth:0 borderColor:nil];
}
...
- (UIImage *)fc_imageByRoundCornerRadius:(CGFloat)radius
    ...
    return [self fc_imageByRoundCornerRadius:radius
