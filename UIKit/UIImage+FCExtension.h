...
//截屏
+(instancetype)fc_snapshotCurrentScreen;
...
//圆形图片
+ (UIImage *)fc_GetRoundImagewithImage:(UIImage *)image;

//在图片上加居中的文字
- (UIImage *)fc_imageWithTitle:(NSString *)title fontSize:(CGFloat)fontSize titleColor:(UIColor *)titleColor;
...
/**
 ...
 @return 图片上这一点的颜色
 */
- (UIColor *)fc_colorAtPixel:(CGPoint)point;
